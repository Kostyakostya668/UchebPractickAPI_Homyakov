...
using UchebPractickAPI_Homyakov.Models;
...
namespace UchebPractickAPI_Homyakov.Services
{
    public class ScheduleService : IScheduleService
    {
        ...
        private static LessonDto BuildLessonDto(IGrouping<dynamic, Schedule>
            lessonGroup)
        {
        ...
        private static Dictionary<DateTime, List<Schedule>>
            GroupSchedulesByDate(List<Schedule> schedules)
        {
            return schedules
